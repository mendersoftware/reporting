...
type Deployment struct {
	...
	DeploymentPhaseId           string              `json:"deployment_phase_id"`
	...
	DeviceDeleted               *time.Time          `json:"device_deleted"`
	...
	ImageArtifactInfoFormat     string              `json:"image_artifact_info_format"`
	ImageArtifactInfoVersion    uint                `json:"image_artifact_info_version"`
	ImageProvides               map[string]string   `json:"image_provides"`
	ImageDepends                map[string][]string `json:"image_depends"`
	ImageClearsProvides         []string            `json:"image_clears_provides"`
