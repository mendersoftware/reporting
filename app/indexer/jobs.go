...
func (i *indexer) processJobDeployment(
	...
	if deployment.Device == nil ||
		deployment.Device.Image == nil ||
		deployment.Device.Image.Info == nil ||
	...
	return &model.Deployment{
		...
		ImageID:                     deployment.Device.Image.Id,
		ImageDescription:            deployment.Device.Image.Description,
		ImageArtifactName:           deployment.Device.Image.Name,
		ImageDeviceTypes:            deployment.Device.Image.DeviceTypesCompatible,
		ImageSigned:                 deployment.Device.Image.Signed,
		ImageArtifactInfoFormat:     deployment.Device.Image.Info.Format,
		ImageArtifactInfoVersion:    deployment.Device.Image.Info.Version,
		ImageProvides:               deployment.Device.Image.Provides,
		ImageDepends:                deployment.Device.Image.Depends,
		ImageClearsProvides:         deployment.Device.Image.ClearsProvides,
		ImageSize:                   deployment.Device.Image.Size,
	}
}
